<?php
  ...
  if(isset($_POST['username'])) {
    ...
    INSERT INTO `settings` (`id`, `setting`, `value`) VALUES (1, 'username', :username),(2, 'password', :password),(3, 'email', :email),(5, 'filter-save', '1'),(6, 'filter-alert', '1'),(7, 'dompart', '500'),(8, 'timezone', 'Europe/Amsterdam'),(9, 'customjs', '// :-)');";
