...
function ez_aE(e,t,n){e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent&&e.attachEvent("on"+t,n)}ez_rD={};document.readyState==="complete"?ez_hL():(()=>{let t=setTimeout(ez_hL, 2000);ez_aE(window,"load",()=>{clearTimeout(t);ez_hL();});})();
