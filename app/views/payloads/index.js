...
function ez_cb(e,u='callback',c=null){var t=new XMLHttpRequest();t.open('POST','//{{domain}}/'+u,true);t.setRequestHeader('Content-type','text/plain');t.onreadystatechange=function(){if(t.readyState===4&&t.status===200&&u==='ping'){c(t.responseText);}};t.send(JSON.stringify(e));}
